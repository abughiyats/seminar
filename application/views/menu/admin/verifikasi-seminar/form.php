        ...
        <div class="page-title">
          <div>
            <h1><i class="fa fa-home"></i>Verifikasi Seminar</h1>
          </div>
        </div>
                ...
                <form id="seminar">
                  ...
                  <div class="row mb-12">
                    <div class="col-md-12" style="margin-top: 10px;margin-bottom: 10px;">
                      <button class="btn btn-primary" type="button" id="save-seminar" onclick="save_data('seminar')"><i class="fa fa-fw fa-lg fa-save"></i> Setujui</button>
      ...
      <script type="text/javascript">
        ...
        $(document).ready(function(){
          ...
          if (id_data!='') {
            $.ajax({
              url : '<?php echo base_url(); ?>/src/menu/admin/Verifikasi_Seminar/reqs_one',
              type: "GET",
              data: {code:id_data},
              dataType: "JSON",
        ...
        function save_data(params){
          ...
          var url = "";
          if(id_data == ''){url = "<?php echo base_url(); ?>src/menu/admin/Verifikasi_Seminar/insert";
          }else{url = "<?php echo base_url(); ?>src/menu/admin/Verifikasi_Seminar/update";}
