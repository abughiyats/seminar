        ...
        <div class="page-title">
          <div>
            <h1><i class="fa fa-home"></i>Jadwal Seminar</h1>
          </div>
        </div>
        ...
        <div class="form-group text-left">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-hover datatable" id="table-jadwal-seminar">
                <thead>
                    <tr>
                      <th>No</th>
                      <th>Kode</th>
      ...
      <script type="text/javascript">
        ...
        $(document).ready(function() {
            //datatables
            table = $('#table-jadwal-seminar').DataTable({ 
                // Load data for the table's content from an Ajax source
                "ajax": {
                    "url": "<?php echo site_url('src/menu/Jadwal_Seminar/ajax_list')?>",
                    "type": "GET"
                },
                "columnDefs": [{ 
                  "orderable": false, 
        ...
        function delete_seminar(id_data){
         // ajax adding data to database
          $.ajax({
            url : "<?php echo base_url(); ?>src/menu/Jadwal_Seminar/delete",
            type: "GET",
