          ...
          <div class="card-body">
            <div class="row" style="margin-right: 5px;margin-left: 5px;">
              <div class="col-md-12">
                ...
                <form id="seminar">
                  <div class="clearfix col-md-6" hidden="true">
                    <label>Code</label>
                  ...
                  <div class="clearfix col-md-6">
                    ...
                    <input class="form-control" type="text" name="seminar_title" readonly="true">
                  </div>
                  <div class="clearfix col-md-6">
                    <label>seminar_date</label>
                    <input class="form-control datepicker" type="text" name="seminar_target_date" readonly="true" disabled="true">
                  </div>
                  <div class="clearfix col-md-6">
                    <label>pembicara</label>
                    <input class="form-control" type="text" name="seminar_pembicara" readonly="true">
                  </div>
                  <div class="clearfix col-md-3">
                    <label>open_regist_date</label>
                    <input class="form-control datepicker" type="text" name="seminar_open_regist_date" readonly="true" disabled="true">
                  </div>
                  <div class="clearfix col-md-3">
                    <label>close_regist_date</label>
                    <input class="form-control datepicker" type="text" name="seminar_close_regist_date" readonly="true" disabled="true">
                  </div>
                  <div class="clearfix col-md-3">
                    <label>qouta</label>
                    <input class="form-control" type="number" name="seminar_qouta" readonly="true">
                  </div>
                  <div class="clearfix col-md-3">
                    <label>price</label>
                    <input class="form-control" type="number" name="seminar_price" readonly="true">
                  </div>
                  <div class="clearfix col-md-3" hidden="">
                    <label>price</label>
                    <input class="form-control" type="number" name="saldo" readonly="true">
                  </div>
                  <div class="clearfix col-md-6">
                    <label>certificate_status</label>
                    <input class="form-control" type="text" name="seminar_certificate_status" readonly="true">
                  </div>
                  <div class="clearfix col-md-6">
                    <label>remark</label>
                    <input class="form-control" type="text" name="seminar_remark" readonly="true">
                  </div>
                  <div class="row mb-12">
                    <div class="col-md-12" style="margin-top: 10px;margin-bottom: 10px;">
                      <button class="btn btn-primary" type="button" id="save-seminar" onclick="save_data('seminar')"><i class="fa fa-fw fa-lg fa-save"></i> Daftar</button>
      ...
      <script type="text/javascript">
        ...
        $(document).ready(function(){
          ...
          if (id_data!='') {
            $.ajax({
              url : '<?php echo base_url(); ?>/src/menu/peserta/Seminar/reqs_one',
              type: "GET",
              data: {code:id_data},
              dataType: "JSON",
        ...
        function save_data(params){
          var saldo = ($("#saldo_prfl").val()-$("form [name='seminar_price']").val());
          $("form [name='saldo']").val(saldo);
          if(saldo <=0 ){
            show_message("PENDAFTARAN GAGAL!!<br>Saldo anda sisa : Rp."+numberWithCommas($("#saldo_prfl").val()),3);
            return;
          }
          // #validasi form
          var hasil= $("#saldo_prfl").val()-$("form [name='seminar_qouta']").val();
          // alert(hasil);
          if(hasil<=0){
            show_message("Saldo Anda Tidak Mencukupi!",3);
            return;
          }
          $("#".params).LoadingOverlay("show");
          var url = "";
          if(id_data == ''){url = "<?php echo base_url(); ?>src/menu/peserta/Seminar/insert";
          }else{url = "<?php echo base_url(); ?>src/menu/peserta/Seminar/update";}
