            ...
            <div class="row" style="margin-right: 5px;margin-left: 5px;">
              <div class="col-md-12">
                ...
                <form id="seminar">
                  ...
                  <div class="clearfix col-md-3">
                    <label>Lokasi</label>
                    <input class="form-control" type="text" name="seminar_location">
                  </div>
                  <div class="clearfix col-md-3">
                    <label>HTM/Biaya</label>
                    <input class="form-control" type="number" name="seminar_price">
                  </div>
                  <div class="clearfix col-md-3">
                    <label>Sertifikat</label>
                    <select class="form-control" name="seminar_certificate_status">
                  ...
                  <div class="clearfix col-md-3">
                    <label>Lokasi</label>
                    <input class="form-control" type="text" name="seminar_loakasi">
                  </div>
                  <div class="clearfix col-md-6">
      ...
      <script type="text/javascript">
        ...
        $(document).ready(function(){
          ...
          if (id_data!='') {
            $.ajax({
              url : '<?php echo base_url(); ?>/src/menu/organisasi/Seminar/reqs_one',
              type: "GET",
              data: {code:id_data},
              dataType: "JSON",
        ...
        function save_data(params){
          ...
          var url = "";
          if(id_data == ''){url = "<?php echo base_url(); ?>src/menu/organisasi/Seminar/insert";
          }else{url = "<?php echo base_url(); ?>src/menu/organisasi/Seminar/update";}
