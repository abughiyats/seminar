...
<html>
	...
	<body>
		<header>
			...
			<span><img style="width: 14rem;" alt="" src="<?php echo base_url(); ?>assets/images/devjr-landscape-name.png"><input type="file" accept="image/*"></span>
		</header>
		<article>
			<h1>example</h1>
			<address>
			...
			<table class="meta">
				<tr>
					<th><span>Invoice #example</span></th>
				...
				<tr>
					...
					<td><span id="prefix">$</span><span>00000</span></td>
				</tr>
			</table>
