...
|
*/
// $config['base_url'] = 'http://localhost/template/index.php';
...
|
*/
$config['encryption_key'] = 'de4ragil';
...
$config['csrf_token_name'] = 'csrf_'.NAME_SESSION;
$config['csrf_cookie_name'] = 'csrf_cookie_'.NAME_SESSION;
