...
class User_Model extends CI_Model {
	...
	var $code = 'code';
	var $table = 'mst_user';
	var $code_table = "mst_user.code";
	var $column_search = array(
						  'mst_user.code'
						  ,'mst_user.name'
						  ,'mst_user.create_by'
						  ,'mst_user.create_date'
						  ,'mst_user.update_by'
						  ,'mst_user.update_date'
						);
	...
	var $column_select = array(
						   'mst_user.code AS user_code'
						  ,'mst_user.name AS user_name'
						  ,'mst_user.create_by AS user_create_by'
						  ,'mst_user.create_date AS user_create_date'
						  ,'mst_user.update_by AS user_update_by'
						  ,'mst_user.update_date AS user_update_date'
					);
	var $order = array(
					"mst_user.code" => 'ASC'
				);
