...
class Seminar_Model extends CI_Model {
	...
	var $column_search = array(
						  ...
						  ,'mn_seminar.remark'
						  ,'mn_seminar.created_by'
						  ,'mn_seminar.created_date'
						  ,'mn_seminar.updated_by'
						  ,'mn_seminar.updated_date'
						);
	...
	var $column_select = array(
						   'mn_seminar.code AS seminar_code'
						  ,'mn_seminar.organisasi_code AS seminar_organisasi_code'
						  ,'mn_seminar.title AS seminar_title'
						  ,'mn_seminar.target_date AS seminar_target_date'
						  ,'mn_seminar.pembicara AS seminar_pembicara'
						  ,'mn_seminar.open_regist_date AS seminar_open_regist_date'
						  ,'mn_seminar.close_regist_date AS seminar_close_regist_date'
						  ,'mn_seminar.qouta AS seminar_qouta'
						  ,'mn_seminar.location AS seminar_location'
						  ,'mn_seminar.price AS seminar_price'
						  ,'mn_seminar.certificate_status AS seminar_certificate_status'
						  ,'mn_seminar.remark AS seminar_remark'
						  ,'mn_seminar.created_by AS seminar_created_by'
						  ,'mn_seminar.created_date AS seminar_created_date'
						  ,'mn_seminar.updated_by AS seminar_updated_by'
						  ,'mn_seminar.updated_date AS seminar_updated_date'
					);
	var $order = array(
					"mn_seminar.code" => 'ASC'
				);
