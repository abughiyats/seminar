...
class Management_Peserta_Model extends CI_Model {

	var $alias = 'management_peserta';
	var $code = 'code';
	...
	var $column_search = array(
						  ...
						  ,'sys_profile.photo'
						  ,'sys_profile.status'
						  ,'sys_profile.created_by'
						  ,'sys_profile.created_date'
						  ,'sys_profile.updated_by'
						  ,'sys_profile.updated_date'
						);
	...
	var $column_select = array(
						   'sys_profile.code AS management_peserta_code'
						  ,'sys_profile.first_name AS management_peserta_first_name'
						  ,'sys_profile.last_name AS management_peserta_last_name'
						  ,'sys_profile.organisasi_code AS management_peserta_organisasi_code'
						  ,'sys_profile.saldo AS management_peserta_saldo'
						  ,'sys_profile.birthdate AS management_peserta_birthdate'
						  ,'sys_profile.email AS management_peserta_email'
						  ,'sys_profile.phone AS management_peserta_phone'
						  ,'sys_profile.phone_wa AS management_peserta_phone_wa'
						  ,'sys_profile.age AS management_peserta_age'
						  ,'sys_profile.gender AS management_peserta_gender'
						  ,'sys_profile.address AS management_peserta_address'
						  ,'sys_profile.photo AS management_peserta_photo'
						  ,'sys_profile.status AS management_peserta_status'
						  ,'sys_profile.created_by AS management_peserta_created_by'
						  ,'sys_profile.created_date AS management_peserta_created_date'
						  ,'sys_profile.updated_by AS management_peserta_updated_by'
						  ,'sys_profile.updated_date AS management_peserta_updated_date'
					);
	var $order = array(
