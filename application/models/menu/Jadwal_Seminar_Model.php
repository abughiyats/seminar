...
class Jadwal_Seminar_Model extends CI_Model {
	...
	var $column_select = array(
						  ...
						  ,'mn_seminar.company_code AS seminar_company_code'
						  ...
						  ,'mn_seminar.create_by AS seminar_create_by'
						  ,'mn_seminar.create_date AS seminar_create_date'
						  ,'mn_seminar.update_by AS seminar_update_by'
						  ,'mn_seminar.update_date AS seminar_update_date'
					);
	var $order = array(
					"mn_seminar.code" => 'ASC'
				);
