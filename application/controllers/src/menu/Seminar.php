...
class Seminar extends REST_Controller {	
	...
	public function index_GET(){
        $mn_tambah = "'".base_url('src/menu/seminar')."?m_pfx=form'";
        $mn_cancel = "'".base_url('src/menu/seminar')."?m_pfx=view'";
        $mn = "'".base_url('src/menu/seminar')."?m_pfx=form'";
		...
		if(!empty($this->input->get('m_pfx'))){
			if($this->input->get('m_pfx')=="form"){
				$this->load->view('menu/seminar/form.php',$data);
				return;
			}
		}
		$this->load->view('menu/seminar/view.php',$data);
		return;
	}
	...
	public function index_POST(){
		...
		print $this->load->view('menu/seminar/form.php',$data);
	}
	...
	public function ajax_list_GET(){
		...
		foreach ($result as $seminar_list) {
        	$edit_seminar = "'".base_url('src/menu/seminar')."?m_pfx=form&code=".$seminar_list->seminar_code."'";
